...
def AddBaseAdmin():
    ...
    for i in amenities:
        db.session.add(i)
        db.session.commit()
    admin = User(id=0, firstname="nithyasree",lastname="vadapalli", email="nithyasree.iitkgp@gmail.com",username="nithya", password="1234", address="Hyderabad , Telangana", age=19, gender="Female", rollstd="GH001",usertype="Admin")
